...
| Area           | Focus                                  |
| -------------- | -------------------------------------- |
| 💻 Development | Java Backend Projects with Spring Boot |
| 📚 Learning    | Data Structures, Algorithms, Databases |
| ☁️ Cloud       | AWS Fundamentals & Cloud Concepts      |
| 🐧 System      | Linux & DevOps Basics                  |
| 🇯🇵 Japanese  | Daily JLPT N2 Preparation              |
